...
import UIKit
import Kingfisher
class DoneServiceDetailesViewController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "DoneServiceWorkerCell", for: indexPath) as! DoneServiceDetaileWorkerViewCell
    ...
    @IBOutlet weak var getInvoiceButton: UIButton!
    ...
    @IBAction func getInvoiceButtonClicked(_ sender: UIButton) {
        let myUrl = "https://bill.pinwork.co/" +          service["service_code"].stringValue
    ...
    override func viewDidLoad() {
        ...
        getInvoiceButton.layer.borderWidth = 1
        getInvoiceButton.layer.borderColor = getPinworkColors(color: 1).cgColor
        getInvoiceButton.layer.cornerRadius = 8
        ...
        getInvoiceButton.layer.shadowOffset = CGSize(width: 3, height: 3)
        getInvoiceButton.layer.shadowRadius = 2
        getInvoiceButton.layer.shadowOpacity = 0.5
